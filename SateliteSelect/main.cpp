...
void VelocityCheck(const char* filename, LLAPos Station, CSGP4_SDP4* SatteliteModel) {
    ...
    auto now_tm = *gmtime(&now_time_t); // ���������� gmtime ��� ��������� ������� � UTC
...
double TimeIntersect(CSGP4_SDP4 SatteliteModel, LLAPos StationLLA_1) {
    ...
    double time = SatteliteModel.JulianDate(now_tm); // ������ �������
    double tempTime = SatteliteModel.JulianDate(temp); // ��������� ����������
    double time2 = SatteliteModel.JulianDate(Time2); // ������� �������
